  ...
  return (
    <>
      <div className='relative overflow-hidden lg:overflow-visible'>
        ...
        >
          I'm a skilled full-stack developer with expertise in JavaScript, TypeScript, 
          Java, Python, and Dart. I specialize in building modern web applications using 
          React, Spring Boot, Node.js, and Flutter for mobile development. I have experience 
          in machine learning projects including facial expression recognition, vest detection, 
          and hand gesture recognition. I'm passionate about creating innovative solutions that 
          bridge web development, mobile apps, and AI technologies.
        </motion.p>
